...
SYS_CONFIG = {
    # 企业微信企业ID，非必填
    # 需要发送企业微信消息时必填
    "corpid": "ww93c25557f374b4de",

    # 企业微信应用Secret，非必填
    # 需要发送企业微信消息时必填
    "corpsecret": "O6h2U5PdEOD8sKEHYxo2Oxi1El_8RIrC-5WkhRqVC18",
    ...
    # 测试号appID，非必填
    # 需要测试号发送时必填wx510a03984901e359
    "appid": "",

    # 测试号appsecret，非必填
    # 需要测试号发送时必填80e9ace386e51bf80f5ed713ce9e0d4a
    "appsecret": "",
    ...
    # 和风天气Key，非必填
    # 需要天气信息时必填
    "qweather": "968e2120f54a438891c66c02a19b9ca3",
